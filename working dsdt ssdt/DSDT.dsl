 ...
 *
 * Disassembly of DSDT.aml, Sat Mar  4 20:24:36 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001314F (78159)
 *     Revision         0x02
 *     Checksum         0x8A
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xAE87BE18, 0x01D1)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120042))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x0C, Local2)
                            And (Local2, 0xFFFF, Local2)
                            Return (Local2)
                        }
                    }
